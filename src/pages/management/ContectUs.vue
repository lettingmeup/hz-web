    ...
    <div style="width: 100%;text-align: center">
      <Row type="flex" style="padding-top: 20px">
       qq二维码： <img style="width: 100px;height: 100px" :src="all.qq"/>
        <Upload
          :on-success="getBack"
          action="http://www.hhjxedu.com/hhjx/contact/getQQ.do">
      ...
      <Row type="flex" style="padding-top: 20px">
        ...
        <Upload
          :on-success="getBack"
          action="http://www.hhjxedu.com/hhjx/contact/getWechat.do">
      ...
      <Row type="flex" style="padding-top: 20px">
        ...
        <Upload
          :on-success="getBack"
          action="http://www.hhjxedu.com/hhjx/contact/getBackground.do">
