...
<script>
  ...
  export default {
    ...
    methods:{
      getdep(){
        var vm = this;
        var url = "http://49.232.53.207/hhjx/aboutMe/getAboutDep.do"
        var data={
          type:1
        }
      ...
      getScoll(){
        var vm = this;
        var url = "http://49.232.53.207/hhjx/aboutMe/getAboutScoll.do"
      ...
      getAboutData(){
        var vm = this;
        var url = "http://49.232.53.207/hhjx/aboutMe/getAboutMeData.do"
        this.$axios.post(url).then(function (res) {
